...
<style type="text/css">
    ...
    .wrapper .btn a {
        ...
        color: #fff !important;
        outline-color: #ef752a;
        text-shadow: 0 1px 0 #d76926
    }

    .wrapper .btn a:hover {
        background-color: #d76926 !important;
        color: #fff !important;
        outline-color: #d76926 !important
    }
                ...
                <table style="border-collapse: collapse;border-spacing: 0;width: 602px">
                    ...
                    <tr>
                        <td class="title"
                            ...
                            Contest publish request from {{ $maintainer }}.
                        </td>
                    </tr>
                    </tbody>
                </table>
                            ...
                            <table class="contents"
                                ...
                                <tr>
                                    <td class="padded"
                                        ...
                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
                                            Above contest has been created. To review and publish
                                            <strong style="font-weight: bold">click</strong>&nbsp;button below.
                                        </p>
                                    </td>
                                </tr>
                                </tbody>
                                ...
                                <tr>
                                    <td class="padded"
                                        ...
                                        <div class="btn" style="Margin-bottom: 24px;padding: 2px;text-align: center">
                                            <![if !mso]>
                                            <a style="border: 1px solid #ffffff;display: inline-block;font-size: 13px;font-weight: bold;line-height: 15px;outline-style: solid;outline-width: 2px;padding: 10px 30px;text-align: center;text-decoration: none !important;transition: all .2s;color: #fff !important;font-family: Georgia,serif;background-color: #ef752a;outline-color: #ef752a;text-shadow: 0 1px 0 #d76926"
                                               href="{{ route('contest.review', [$slug, $token]) }}">
                                                Review Contest</a>
                                            <![endif]>
                                            <!--[if mso]>
                                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml"
                                                    href="{{ route('contest.review', [$slug, $token]) }}"
                                                    style="width:165px" fillcolor="#EF752A" strokecolor="#EF752A"
                                                    strokeweight="6px">
                                                <v:stroke linestyle="thinthin"></v:stroke>
                                                <v:textbox style="mso-fit-shape-to-text:t" inset="0px,7px,0px,7px">
                                                    <center style="font-size:13px;line-height:15px;color:#FFFFFF;font-family:Georgia,serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:0px">
                                                        Review Contest
                                                    </center>
                                                </v:textbox>
                                            </v:rect>
                    ...
                    <tr>
                        <td class="address"
                            ...
                            <table class="contents"
                                ...
                                <tr>
                                    <td class="padded"
                                        style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;word-break: break-word;word-wrap: break-word;text-align: left;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif">
                                        <div>Whizzspace.com</div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <td class="subscription"
                            ...
                            <table class="contents"
                                ...
                                <tr>
                                    <td class="padded"
                                        style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;word-break: break-word;word-wrap: break-word;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;text-align: right">
                                        <div>You are the administrator of whizzspace.com</div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
