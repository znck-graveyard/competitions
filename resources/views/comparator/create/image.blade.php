{{--This is temp file to store original abstract view.--}}
@extends('app')
            ...
            <div class="arena left">
                <div class="entries">
                    <div class="entry left text-center">
                        <div class="wrapper">
                            <div class="content" style="background-image: url('{{ asset('image/placeholder.jpg') }}')">
                                <img src="{{ $one->imageUrl() }}" alt="{{ $one->title }}"/>
                            </div>
                            <div class="caption">
                                <div class="profile">
