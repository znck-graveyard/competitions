    ...
    <script>
        $(document).ready(function () {
            ...
            @if($user->date_of_birth)
                .datepicker('update', "{{ $user->date_of_birth->format('Y-m-d') }}");
            @else
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('first_name', null, ['class' => 'input-lg form-control', 'required' =>'',
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('last_name', null, ['class' => 'input-lg form-control', 'required' =>'',
                        'placeholder' => 'enter your last name', 'id' => 'last-name']) !!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        <label for="username" class="text-uppercase required">Username</label>
                        {!! Form::text('username', null, ['class' => 'input-lg form-control', 'required' =>'',
                        'placeholder' => 'choose your username', 'id' => 'username']) !!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        <label for="email" class="text-uppercase required">email</label>
                        {!! Form::email('email', null, ['class' => 'input-lg form-control', 'required' =>'',
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            {!! Form::text('date_of_birth', $user->date_of_birth ? $user->date_of_birth->format('Y-m-d')
                            : old('date_of_birth'), ['class' => 'input-lg form-control', 'required' =>'', 'placeholder'
                            => 'select your date of birth', 'id' => 'dob', 'data-type'=>'date']) !!}
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        ['class' => 'input-lg form-control', 'required' =>'', 'placeholder' => 'enter your first name',
                        'id' => 'gender']) !!}
                    </div>
                </div>
                    ...
                    <div class="file-input">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div>
                                    {!! Form::text('profile_photo_link', old('cover_link'), ['class' => 'input-lg
                                    form-control', 'placeholder' => 'enter link of the photo',]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="file-input">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div>
                                    {!! Form::text('cover_photo_link', old('cover_link'), ['class' => 'input-lg
                                    form-control', 'placeholder' => 'enter link of the photo',]) !!}
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('bio', old('bio'), ['class' => 'input-lg form-control', 'required' =>'',
                        'placeholder' => 'tell everyone about you', 'id' => 'bio']) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="input-with-icon">
                            ...
                            {!! Form::text('connection_twitter', null, ['class' => 'input-lg form-control',
                            'placeholder' => 'twitter.com/username', 'id' => 'twitter']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-with-icon">
                            ...
                            {!! Form::text('connection_facebook', null, ['class' => 'input-lg form-control',
                            'placeholder' => 'facebook.com/username', 'id' => 'facebook']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-with-icon">
                            ...
                            {!! Form::text('connection_instagram', null, ['class' => 'input-lg form-control',
                            'placeholder' => 'instagram.com/username', 'id' => 'instagram']) !!}
                        </div>
                    </div>
                </div>
